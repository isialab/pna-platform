 ...
 * LICENSE file in the root directory of this source tree.
 */
let p=class extends c{constructor(){super(...arguments),this.condensed=!1,this.narrow=!1,this.fullWidth=!1,this.gridContext={subgrid:!1}}render(){var d;if(this.gridContext={subgrid:!0},null===(d=this.gridContextIn)||void 0===d?void 0:d.subgrid){let d=u.WIDE;return this.narrow?d=u.NARROW:this.condensed&&(d=u.CONDENSED),l`<div subgrid mode=${d} part="grid">
        <slot></slot>
      </div> `}return l`<div grid part="grid">
        <slot></slot>
      </div> `}};p.styles=e,s([r({reflect:!0,type:String})],p.prototype,"align",void 0),s([r({reflect:!0,type:Boolean})],p.prototype,"condensed",void 0),s([r({reflect:!0,type:Boolean})],p.prototype,"narrow",void 0),s([r({reflect:!0,attribute:"full-width",type:Boolean})],p.prototype,"fullWidth",void 0),s([n({context:a,subscribe:!0}),r({attribute:!1})],p.prototype,"gridContextIn",void 0),s([t({context:a}),r({attribute:!1})],p.prototype,"gridContext",void 0),p=s([m(`${i}-grid`)],p);
/**
 * @license
 *
 * Copyright IBM Corp. 2024, 2024
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let y=class extends c{render(){return l`<div part="column-hang">
      <slot></slot>
    </div>`}};y.styles=x,y=s([m(`${i}-column-hang`)],y);
